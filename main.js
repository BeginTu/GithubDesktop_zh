...
, function(e, t, n) {
    var r, i, o = n(2), s = n(85), a = n(86), c = n(87), u = n(5);
    function l(e, t) {
    ...
    "function" == typeof Symbol && "function" == typeof Symbol.for ? (r = Symbol.for("graceful-fs.queue"),
    i = Symbol.for("graceful-fs.previous")) : (r = "___graceful-fs.queue",
    i = "___graceful-fs.previous");
    var f = function() {};
    ...
    function p(e) {
        ...
        e.readFile = function(e, n, r) {
            ...
            return function e(n, r, i) {
                return t(n, r, (function(t) {
                    !t || "EMFILE" !== t.code && "ENFILE" !== t.code ? ("function" == typeof i && i.apply(this, arguments),
                    m()) : d([e, [n, r, i]])
                }
                ))
            }(e, n, r)
        ...
        e.writeFile = function(e, t, r, i) {
            ...
            return function e(t, r, i, o) {
                return n(t, r, i, (function(n) {
                    !n || "EMFILE" !== n.code && "ENFILE" !== n.code ? ("function" == typeof o && o.apply(this, arguments),
                    m()) : d([e, [t, r, i, o]])
                }
                ))
            }(e, t, r, i)
        ...
        r && (e.appendFile = function(e, t, n, i) {
            ...
            return function e(t, n, i, o) {
                return r(t, n, i, (function(r) {
                    !r || "EMFILE" !== r.code && "ENFILE" !== r.code ? ("function" == typeof o && o.apply(this, arguments),
                    m()) : d([e, [t, n, i, o]])
                }
                ))
            }(e, t, n, i)
        ...
        if (e.readdir = function(e, t, n) {
            ...
            return r.push((function(e, t) {
                t && t.sort && t.sort();
                !e || "EMFILE" !== e.code && "ENFILE" !== e.code ? ("function" == typeof n && n.apply(this, arguments),
                m()) : d([o, [r]])
            }
            )),
            o(r)
        ...
        var u = e.ReadStream;
        u && (y.prototype = Object.create(u.prototype),
        y.prototype.open = function() {
            var e = this;
            w(e.path, e.flags, e.mode, (function(t, n) {
                t ? (e.autoClose && e.destroy(),
                e.emit("error", t)) : (e.fd = n,
                e.emit("open", n),
                e.read())
            }
            ))
        ...
        var l = e.WriteStream;
        l && (g.prototype = Object.create(l.prototype),
        ...
        var h = g;
        function y(e, t) {
            return this instanceof y ? (u.apply(this, arguments),
            this) : y.apply(Object.create(y.prototype), arguments)
        }
        function g(e, t) {
            return this instanceof g ? (l.apply(this, arguments),
            this) : g.apply(Object.create(g.prototype), arguments)
        }
        ...
        function w(e, t, n, r) {
            ...
            function e(t, n, r, i) {
                return v(t, n, r, (function(o, s) {
                    !o || "EMFILE" !== o.code && "ENFILE" !== o.code ? ("function" == typeof i && i.apply(this, arguments),
                    m()) : d([e, [t, n, r, i]])
                }
                ))
            }(e, t, n, r)
    ...
    function m() {
        var e = o[r].shift();
        e && (f("RETRY", e[0].name, e[1]),
        e[0].apply(null, e[1]))
    }
    global[r] || l(global, o[r]),
    e.exports = p(c(o)),
    process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !o.__patched && (e.exports = p(o),
    o.__patched = !0)
}
, function(e, t, n) {
    "use strict";
...
, function(e, t, n) {
    ...
    r.Container = n(83).Container,
    r.Logger = n(84).Logger,
    ...
    ["log", "query", "stream", "add", "remove", "clear", "profile", "startTimer", "extend", "cli", "handleExceptions", "unhandleExceptions", "configure"].forEach((function(e) {
        r[e] = function() {
...
, function(e, t, n) {
    ...
    t.setLevels = function(e, n, r, i) {
        ...
        e.levels = r || u.npm.levels,
        e.padLevels && (e.levelLength = t.longestElement(Object.keys(e.levels))),
        Object.keys(e.levels).forEach((function(t) {
            "log" !== t ? e[t] = function(n) {
                var r = [t].concat(Array.prototype.slice.call(arguments));
                e.log.apply(e, r)
            }
            : console.warn('名为“log”的日志级别将与方法“log”发生冲突。考虑使用不同的名称。')
        }
        )),
        e
    }
    ...
    t.clone = function(e) {
        ...
        for (var r in e)
            Array.isArray(e[r]) || e[r]instanceof Buffer ? n[r] = e[r].slice(0) : "function" != typeof e[r] ? n[r] = e[r]instanceof Object ? t.clone(e[r]) : e[r] : "function" == typeof e[r] && (n[r] = e[r]);
        return n
    }
    ,
    t.log = function(e) {
        var n, i = "function" == typeof e.timestamp ? e.timestamp : t.timestamp, s = e.timestamp ? i() : null, a = void 0 === e.showLevel || e.showLevel, c = null === e.meta || void 0 === e.meta || e.meta instanceof Error ? e.meta || null : t.clone(o.decycle(e.meta));
        if (e.raw)
            return "object" != typeof c && null != c && (c = {
                meta: c
            }),
            (n = t.clone(c) || {}).level = e.level,
            n.message = e.message.stripColors ? e.message.stripColors : e.message,
            JSON.stringify(n);
        if (e.json || !0 === e.logstash) {
            ...
            !0 === e.logstash) {
                var l = {};
                void 0 !== n.message && (l["@message"] = n.message,
                delete n.message),
                void 0 !== n.timestamp && (l["@timestamp"] = n.timestamp,
                delete n.timestamp),
                l["@fields"] = t.clone(n),
                n = l
            }
        ...
        if ("function" == typeof e.formatter)
            return e.meta = c,
            String(e.formatter(t.clone(e)));
        if (n = s ? s + " - " : "",
        a && (n += "all" === e.colorize || "level" === e.colorize || !0 === e.colorize ? u.colorize(e.level) : e.level),
        n += e.align ? "\t" : "",
        n += s || a ? ": " : "",
        n += e.label ? "[" + e.label + "] " : "",
        n += "all" === e.colorize || "message" === e.colorize ? u.colorize(e.level, e.message) : e.message,
        null != c)
            if (c && c instanceof Error && c.stack && (c = c.stack),
            "object" != typeof c)
                n += " " + c;
    ...
    t.serialize = function(e, n) {
        if ("symbol" == typeof n && (n = n.toString()),
        "symbol" == typeof e && (e = e.toString()),
        null === e ? e = "null" : void 0 === e ? e = "undefined" : !1 === e && (e = "false"),
        "object" != typeof e)
            return n ? n + "=" + e : e;
        ...
        for (var r = "", i = Object.keys(e), o = i.length, s = 0; s < o; s++) {
            if (Array.isArray(e[i[s]])) {
                ...
                for (var a = 0, c = e[i[s]].length; a < c; a++)
                    r += t.serialize(e[i[s]][a]),
                    a < c - 1 && (r += ", ");
                r += "]"
            } else
                e[i[s]]instanceof Date ? r += i[s] + "=" + e[i[s]] : r += t.serialize(e[i[s]], i[s]);
            s < o - 1 && (r += ", ")
        }
        return r
    }
    ...
    t.tailFile = function(e, t) {
        ...
        s.open(e.file, "a+", "0644", (function(a, c) {
            if (a)
                return t ? t(a) : i.emit("error", a),
                void i.destroy();
            !function a() {
                if (!i.destroyed)
                    return s.read(c, n, 0, n.length, u, (function(s, c) {
                        if (s)
                            return t ? t(s) : i.emit("error", s),
                            void i.destroy();
                        if (!c)
                            return o && ((null == e.start || l > e.start) && (t ? t(null, o) : i.emit("line", o)),
                            l++,
                            o = ""),
                            setTimeout(a, 1e3);
                        ...
                        for (var h = (f = (o + f).split(/\n+/)).length - 1, p = 0; p < h; p++)
                            (null == e.start || l > e.start) && (t ? t(null, f[p]) : i.emit("line", f[p])),
                            l++;
                        return o = f[h],
                        u += c,
                        a()
    ...
    t.stringArrayToSet = function(e, t) {
        return void 0 === t && (t = "无法从具有非字符串元素的数组中进行设置"),
...
, function(e, t, n) {
    var r = n(14)
      ...
      , o = t.Transport = function(e) {
        ...
        this.humanReadableUnhandledException = e.humanReadableUnhandledException || !1
    }
    ;
    ...
    o.prototype.normalizeQuery = function(e) {
        return (e = e || {}).rows = e.rows || e.limit || 10,
        e.start = e.start || 0,
...
, function(e, t, n) {
    ...
    function l(e, t) {
        if (t.ino && t.dev && t.ino === e.ino && t.dev === e.dev) {
            if (s || t.ino < Number.MAX_SAFE_INTEGER)
                return !0;
    ...
    e.exports = {
        checkPaths: function(e, t, n, r) {
            o.callbackify(u)(e, t, (i,o)=>{
                ...
                return a && l(s, a) ? r(new Error("源和目标不能相同。")) : s.isDirectory() && f(e, t) ? r(new Error(h(e, t, n))) : r(null, {
                    srcStat: s,
                    destStat: a
                })
            }
        ...
        checkPathsSync: function(e, t, n) {
            ...
            if (r.isDirectory() && f(e, t))
                throw new Error(h(e, t, n));
            return {
                srcStat: r,
                destStat: i
            }
...
, function(e, t, n) {
    ...
    i.colorize = function(e, t) {
        ...
        if (o[e]instanceof Array)
            for (var i = 0, s = o[e].length; i < s; ++i)
                n = r[o[e][i]](n);
        else if (o[e].match(/\s/)) {
            var a = o[e].split(/\s+/);
...
, function(e, t) {
    e.exports = {
        ...
        stripBom: function(e) {
            return Buffer.isBuffer(e) && (e = e.toString("utf8")),
            e.replace(/^\uFEFF/, "")
        }
    }
}
 ...
 */
    !function() {
        ...
        null != (n = "object" == typeof window && this === window ? window : "object" == typeof global && this === global ? global : this) && (i = n.async),
        ...
        "undefined" != typeof process && process.nextTick ? (o.nextTick = process.nextTick,
        o.setImmediate = c ? function(e) {
            c(e)
        }
        ...
        o.queue = function(e, t) {
            if (void 0 === t)
                ...
                throw new Error("并发不能为零");
            function n(e, t, n, r) {
                if (e.started || (e.started = !0),
                l(t) || (t = [t]),
                0 === t.length)
                ...
                f(t, (function(t) {
                    ...
                    e.saturated && e.tasks.length === e.concurrency && e.saturated(),
        ...
        o.memoize = function(e, t) {
            ...
            var i = function() {
                ...
                e.apply(null, i.concat([function() {
                    n[a] = d(arguments);
                    var e = r[a];
                    delete r[a];
...
, function(e, t, n) {
    ...
    a.prototype.applySourceMap = function(e, t, n) {
        ...
        if (null == t) {
            if (null == e.file)
                throw new Error('SourceMapGenerator.prototype.applySourceMap 需要显式源文件或源映射的“文件”属性。而两者都被省略了。');
            r = e.file
        }
    ...
    a.prototype._validateMapping = function(e, t, n, r) {
        if (t && "number" != typeof t.line && "number" != typeof t.column)
            throw new Error("original.line 和 original.column 不是数字——您可能打算完全省略原始映射，只映射生成的位置。如果是这样，则为原始映射传递 null 而不是具有空值或 null 值的对象。");
        if ((!(e && "line"in e && "column"in e && e.line > 0 && e.column >= 0) || t || n || r) && !(e && "line"in e && "column"in e && t && "line"in t && "column"in t && e.line > 0 && e.column >= 0 && t.line > 0 && t.column >= 0 && n))
            throw new Error("无效的映射：" + JSON.stringify({
                generated: e,
                source: n,
                original: t,
                name: r
    ...
    a.prototype._serializeMappings = function() {
        for (var e, t, n, o, s = 0, a = 1, c = 0, u = 0, l = 0, f = 0, h = "", p = this._mappings.toArray(), d = 0, m = p.length; d < m; d++) {
            if (e = "",
            (t = p[d]).generatedLine !== a)
                for (s = 0; t.generatedLine !== a; )
                    e += ";",
                    a++;
            else if (d > 0) {
                if (!i.compareByGeneratedPositionsInflated(t, p[d - 1]))
                    continue;
                e += ","
            }
...
, function(e, t, n) {
    ...
    t.decode = function(e, t, n) {
        ...
        do {
            if (t >= c)
                throw new Error("预计基数为 64 的 VLQ 值中的位数更多。");
            if (-1 === (o = r.decode(e.charCodeAt(t++))))
                throw new Error("无效的 base64 数字：" + e.charAt(t - 1));
            i = !!(32 & o),
            u += (o &= 31) << l,
            l += 5
        } while (i);
...
, function(e, t, n) {
    ...
    function o(e) {
        ...
        if (e.submenu instanceof r.Menu)
            for (const n of e.submenu.items)
                o(n) && (t = !0);
        if (t || e.role)
            return !0;
        const n = e.id;
        return "show-devtools" === n || "reload-window" === n || (e.enabled = !1,
        !1)
    }
}
, function(e, t, n) {
...
, function(e, t, n) {
    ...
    var o = n(25)
      ...
      , a = n(18);
    var c;
    function u({selectedExternalEditor: e, selectedShell: t, askForConfirmationOnForcePush: n, askForConfirmationOnRepositoryRemoval: u, hasCurrentPullRequest: h=!1, defaultBranchName: p="default branch", isForcePushForCurrentRepository: m=!1, isStashedChangesVisible: y=!1, askForConfirmationWhenStashingAllChanges: g=!0}) {
        p = function(e, t) {
            if (e.length <= t)
                return e;
            const n = [...e];
            if (n.length <= t)
                return e;
            const r = n.reduce((e,t)=>(t >= "︀" && t <= "️" ? e.length && e.push(`${e.pop()}${t}`) : e.push(t),
            e), []);
        ...
        x.push({
            label: "重定位当前分支(rebase)…",
            id: "rebase-branch",
            accelerator: "CmdOrCtrl+Shift+E",
            click: f("rebase-branch")
        }, _, {
            label: "在 GitHub 中进行比较",
        ...
        const C = [{
            label: "报告问题…",
            click() {
                r.shell.openExternal("https://github.com/desktop/desktop/issues/new/choose").catch(e=>log.error("打开问题创建页面失败", e))
            }
        }, {
            label: "联系 GitHub 支持…",
            click() {
                r.shell.openExternal("https://github.com/contact?from_desktop_app=1&app_version=" + r.app.getVersion()).catch(e=>log.error("打开联系支持页面失败", e))
            }
        }, {
            label: "打开用户指南",
            click() {
                r.shell.openExternal("https://help.github.com/desktop/guides/").catch(e=>log.error("打开用户指南页面失败", e))
            }
        }, {
            label: "显示键盘快捷键",
            click() {
                r.shell.openExternal("https://help.github.com/en/desktop/getting-started-with-github-desktop/keyboard-shortcuts-in-github-desktop").catch(e=>log.error("无法打开键盘快捷键页面", e))
            }
        }, {
            label: "在资源管理器中显示日志",
            click() {
...
, function(e, t, n) {
    ...
    const r = n(1);
    e.exports = function(e) {
        if ("string" != typeof e || e.length <= 7 || "file://" !== e.substring(0, 7))
            throw new TypeError("必须传入 file:// URI 才能转换为文件路径");
        const t = decodeURI(e.substring(7))
          , n = t.indexOf("/");
        let i = t.substring(0, n)
          , o = t.substring(n + 1);
        return "localhost" === i && (i = ""),
        i && (i = r.sep + r.sep + i),
        o = o.replace(/^(.+)\|/, "$1:"),
        "\\" === r.sep && (o = o.replace(/\//g, "\\")),
        /^.+:/.test(o) || (o = r.sep + o),
...
, function(e, t, n) {
    ...
    function b(e) {
        ...
        if (t && t.map) {
            ...
            if (null !== r.source)
                return r.source = v(t.url, r.source),
                r
        }
        return e
    }
    function _() {
        ...
        if (this.isNative())
            ...
            !(e = this.getScriptNameOrSourceURL()) && this.isEval() && (t = this.getEvalOrigin(),
            t += ", "),
            t += e || "<anonymous>";
        ...
        if (!(this.isToplevel() || a)) {
            ...
            o ? (c && 0 != o.indexOf(c) && (i += c + "."),
            i += o,
            u && o.indexOf("." + u) != o.length - u.length - 1 && (i += " [as " + u + "]")) : i += c + "." + (u || "<anonymous>")
        } else
            a ? i += "new " + (o || "<anonymous>") : o ? i += o : (i += t,
            s = !1);
        return s && (i += " (" + t + ")"),
        i
    }
    ...
    d.push((function(e) {
        var t, n = function(e) {
            ...
            t = g(e);
            for (var i, o, s = /(?:\/\/[@#][ \t]+sourceMappingURL=([^\s'"]+?)[ \t]*$)|(?:\/\*[@#][ \t]+sourceMappingURL=([^\*]+?)[ \t]*(?:\*\/)[ \t]*$)/gm; o = s.exec(t); )
                i = o;
            return i ? i[1] : null
        }(e);
        if (!n)
        ...
        if (h.test(n)) {
            ...
            t = new Buffer(r,"base64").toString(),
            n = e
        } else
            n = v(e, n),
            t = g(n);
    ...
    t.install = function(e) {
        if ((e = e || {}).environment && (u = e.environment,
        -1 === ["node", "browser", "auto"].indexOf(u)))
            throw new Error("未知的环境 " + u + "。可用的选项是 {auto, browser, node}");
        if (e.retrieveFile && (e.overrideRetrieveFile && (p.length = 0),
        p.unshift(e.retrieveFile)),
        e.retrieveSourceMap && (e.overrideRetrieveSourceMap && (d.length = 0),
        ...
        var i;
        (c || (c = "emptyCacheBetweenOperations"in e && e.emptyCacheBetweenOperations),
        s || (s = !0,
        Error.prepareStackTrace = O),
        a) || (!("handleUncaughtExceptions"in e) || e.handleUncaughtExceptions) && "object" == typeof process && null !== process && "function" == typeof process.on && (a = !0,
        i = process.emit,
...
, function(e, t, n) {
    ...
    e.exports = (e,t)=>{
        if ("string" != typeof e)
            throw new TypeError("期望一个字符串，却得到 " + typeof e);
        let n = e;
        return (t = Object.assign({
            resolve: !0
        }, t)).resolve && (n = r.resolve(e)),
        n = n.replace(/\\/g, "/"),
        "/" !== n[0] && (n = "/" + n),
    ...
    e.exports = function(e) {
        ...
        function d() {
            if (!n.getAllDisplays().some(e=>{
                return t = e.bounds,
                a.x >= t.x && a.y >= t.y && a.x + a.width <= t.x + t.width && a.y + a.height <= t.y + t.height;
                var t
            }
            ))
                return p()
        ...
        function b() {
            c && (c.removeListener("resize", g),
            c.removeListener("move", g),
            clearTimeout(u),
        ...
        return a && (h() || a.isMaximized || a.isFullScreen) ? h() && a.displayBounds && d() : a = null,
        a = Object.assign({
            width: l.defaultWidth || 800,
            height: l.defaultHeight || 600
        }, a),
        {
            ...
            unmanage: b,
            manage: function(e) {
                l.maximize && a.isMaximized && e.maximize(),
                l.fullScreen && a.isFullScreen && e.setFullScreen(!0),
                e.on("resize", g),
                e.on("move", g),
                e.on("close", v),
                e.on("closed", w),
...
, function(e, t, n) {
    ...
    var r = n(10)
      ...
      , a = t.Console = function(e) {
        ...
        this.stderrLevels = function(e, t) {
            var n = "stderrLevels 数组中不能有非字符串元素";
            if (t) {
                if (e)
                    throw new Error("不能同时设置 debugStdout 和 stderrLevels");
                return o.stringArrayToSet(["error"], n)
            }
            if (!e)
                return o.stringArrayToSet(["error", "debug"], n);
            if (!Array.isArray(e))
                throw new Error("无法将 stderrLevels 设置为 Array 以外的类型");
    ...
    a.prototype.log = function(e, t, n, r) {
        ...
        this.stderrLevels[e] ? process.stderr.write(i + this.eol) : process.stdout.write(i + this.eol),
        this.emit("logged"),
        r(null, !0)
    }
}
        ...
        return function e(r, i) {
            ...
            if (!("object" != typeof r || null === r || r instanceof Boolean || r instanceof Date || r instanceof Number || r instanceof RegExp || r instanceof String)) {
                ...
                "[object Array]" === Object.prototype.toString.apply(r))
                    ...
                    for (s in a = {},
                    r)
                        Object.prototype.hasOwnProperty.call(r, s) && (a[s] = e(r[s], i + "[" + JSON.stringify(s) + "]"));
                return a
            }
            return r
        }(e, "$")
        ...
        return function(e, t) {
            ...
            e = e.split(""))
                if (!o(s)) {
                    ...
                    var c = ["up", "mid", "down"];
                    for (var u in c)
                        for (var l = c[u], f = 0; f <= r[l]; f++)
                            t[l] && (a += n[l][i(n[l].length)])
                }
            return a
        }(e)
    }
...
, function(e, t, n) {
    var r, i = n(15);
    e.exports = (r = ["red", "yellow", "green", "blue", "magenta"],
    function(e, t, n) {
...
, function(e, t, n) {
    var r, i = n(15);
    e.exports = (r = ["underline", "inverse", "grey", "yellow", "red", "green", "blue", "white", "cyan", "magenta"],
    function(e, t, n) {
...
, function(e, t, n) {
    ...
    var r = n(2)
      ...
      , p = t.File = function(e) {
        ...
        e.filename || e.dirname)
            ...
            this._basename = this.filename = e.filename ? i.basename(e.filename) : "winston.log",
            ...
            if (!e.stream)
                throw new Error("没有文件名或流无法登录到文件。");
            n("stream", "filename", "maxsize"),
            this._stream = e.stream,
            this._isStreams2 = l(this._stream),
    ...
    p.prototype.log = function(e, t, n, r) {
        ...
        this.filename ? this.open((function(e) {
            if (e)
                return i._buffer.push([o, r]);
            i._write(o, r),
            i._size += o.length,
            i._lazyDrain()
        }
    ...
    p.prototype.open = function(e) {
        return this.opening ? e(!0) : !this._stream || this.maxsize && this._size >= this.maxsize ? (e(!0),
        this._createStream()) : (this._archive = this.zippedArchive ? this._stream.path : null,
        void e())
    }
    ,
    ...
    p.prototype._createStream = function() {
        ...
        function t(n) {
            ...
            function s(t) {
                e._stream && (e._stream.end(),
                e._stream.destroySoon()),
                e._size = t,
                e.filename = n,
                e._stream = r.createWriteStream(o, e.options),
                e._isStreams2 = l(e._stream),
                e._stream.on("error", (function(t) {
                    e._failures < e.maxRetries ? (e._createStream(),
                    e._failures++) : e.emit("error", t)
                }
                )),
    ...
    p.prototype._incFile = function(e) {
        ...
        this.tailable ? this._checkMaxFilesTailable(t, n, e) : (this._created += 1,
    ...
    p.prototype._checkMaxFilesIncrementing = function(e, t, n) {
        var o, s;
        if (this.zippedArchive && (this._archive = i.join(this.dirname, t + (1 === this._created ? "" : this._created - 1) + e)),
        !this.maxFiles || this._created < this.maxFiles)
            return n();
        o = this._created - this.maxFiles,
        s = i.join(this.dirname, t + (0 !== o ? o : "") + e + (this.zippedArchive ? ".gz" : "")),
        r.unlink(s, n)
    }
    ,
    ...
    p.prototype._lazyDrain = function() {
        var e = this;
        !this._draining && this._stream && (this._draining = !0,
...
, function(e, t, n) {
    ...
    ;
    r.inherits(u, i.Transport),
    u.prototype.name = "http",
    u.prototype._request = function(e, t) {
    ...
    u.prototype.log = function(e, t, n, r) {
        ...
        n && (n.path && (o.path = n.path,
        delete n.path),
        n.auth && (o.auth = n.auth,
        delete n.auth)),
        this._request(o, (function(e, t) {
            if (t && 200 !== t.statusCode && (e = new Error("HTTP Status Code: " + t.statusCode)),
            e)
                return r(e);
            i.emit("logged"),
            r && r(null, !0)
    ...
    u.prototype.query = function(e, t) {
        ...
        }).params.path && (e.path = e.params.path,
        delete e.params.path),
        e.params.auth && (e.auth = e.params.auth,
        delete e.params.auth),
        this._request(e, (function(e, n, r) {
            if (n && 200 !== n.statusCode && (e = new Error("HTTP Status Code: " + n.statusCode)),
            e)
                return t(e);
            if ("string" == typeof r)
                try {
...
, function(e, t, n) {
    ...
    s.prototype.log = function(e, t, n, r) {
        ...
        "error" === e || "debug" === e ? this.errorOutput.push(o) : this.writeOutput.push(o),
        this.emit("logged"),
        r(null, !0)
    }
    ,
...
, function(e, t) {
    ...
    t.get = function(e) {
        ...
        var o = r.stack;
        return Error.prepareStackTrace = i,
...
, function(e, t, n) {
    ...
    s.prototype.get = s.prototype.add = function(e, t) {
        var n, s = this;
        return this.loggers[e] || (n = (t = o({}, t || this.options || this.default)).transports || this.options.transports,
        t.transports = n ? n.slice() : [],
        0 !== t.transports.length || t && t.console || t.transports.push(this.default.transports[0]),
        Object.keys(t).forEach((function(n) {
            if ("transports" !== n) {
                var o = r.capitalize(n);
                if (!i.transports[o])
                    throw new Error("无法添加未知的传输：" + o);
                var s = t[n];
                s.id = e,
                t.transports.push(new i.transports[o](s))
            }
        }
        )),
        t.id = e,
...
, function(e, t, n) {
    ...
    f.prototype.configure = function(e) {
        ...
        this.transports = {},
        this._names = [],
        e.transports && e.transports.forEach((function(e) {
            t.add(e, null, !0)
        }
        )),
    ...
    f.prototype.log = function(e) {
        for (var t = Array.prototype.slice.call(arguments, 1), n = this; null === t[t.length - 1]; )
            t.pop();
        ...
        if (0 === this._names.length)
            return s(new Error("无法在没有传输的情况下登录。"));
        ...
        if (a.length) {
            var c, u = {}, f = t && t[0] && t[0].match && null !== t[0].match(l), h = f ? t[0].match(l) : [], p = h.filter((function(e) {
                return "%%" === e
            }
            ));
            ...
            if (c = i.format.apply(null, t),
            this.padLevels && (c = new Array(this.levelLength - e.length + 1).join(" ") + c),
        ...
        function y(t) {
            ...
            r = null,
            t || n.emit("logged", e, c, u)
        }
        function g(t, r) {
            var i = n.transports[t];
            i.log(e, c, u, (function(t) {
                if (t)
                    return t.transport = i,
                    y(t),
                    r();
                n.emit("logging", i, e, c, u),
                r()
            }
            ))
        }
    ...
    f.prototype.query = function(e, t) {
        ...
        if (e.transport)
            return e.transport = e.transport.toLowerCase(),
    ...
    f.prototype.handleExceptions = function() {
        ...
        this.catchExceptions || (this.catchExceptions = this._uncaughtException.bind(this),
    ...
    f.prototype.add = function(e, t, n) {
        var r = n ? e : new e(t);
        if (!r.name && !r.log)
            throw new Error("没有 log() 方法的未知传输");
        if (this.transports[r.name])
            throw new Error("运输已经附上：" + r.name + "，分配一个不同的名字");
        return this.transports[r.name] = r,
        this._names = Object.keys(this.transports),
        r._onError = this._onError.bind(this, r),
        n || r.on("error", r._onError),
        r.handleExceptions && !this.catchExceptions && this.handleExceptions(),
        this
    }
    ,
    ...
    f.prototype.remove = function(e) {
        ...
        if (!this.transports[t])
            throw new Error("运输" + t + "未附加到此实例");
        var n = this.transports[t];
        return delete this.transports[t],
        this._names = Object.keys(this.transports),
        n.close && n.close(),
    ...
    f.prototype.profile = function(e) {
        ...
        return this.profilers[e] ? (t = this.profilers[e],
        delete this.profilers[e],
        o = "function" == typeof (n = Array.prototype.slice.call(arguments))[n.length - 1] ? n.pop() : null,
        i = "object" == typeof n[n.length - 1] ? n.pop() : {},
        r = 2 === n.length ? n[1] : e,
        i.durationMs = s - t,
        this.info(r, i, o)) : (this.profilers[e] = s,
        this)
    }
    ,
    ...
    f.prototype.cli = function() {
        return this.padLevels = !0,
        this.setLevels(s.cli.levels),
        s.addColors(s.cli.colors),
        this.transports.console && (this.transports.console.colorize = this.transports.console.colorize || !0,
        this.transports.console.timestamp = this.transports.console.timestamp || !1),
        this
    }
    ,
    f.prototype._uncaughtException = function(e) {
        ...
        if (n = "function" == typeof this.exitOnError ? this.exitOnError(e) : this.exitOnError,
        !s || 0 === s.length)
            return a();
    ...
    h.prototype.done = function(e) {
        ...
        return r.duration = Date.now() - this.start + "ms",
...
, function(e, t, n) {
    ...
    e.exports = function(e) {
        ...
        e.lchmod || (e.lchmod = function(e, t, n) {
        ...
        function u(t) {
            return t ? function(n, r) {
                ...
                return i.uid < 0 && (i.uid += 4294967296),
            ...
            ReadStream: function t(n, i) {
                ...
                if (void 0 !== this.start) {
                    if ("number" != typeof this.start)
                        throw TypeError("开始处必须是一个数字");
                    if (void 0 === this.end)
                        this.end = 1 / 0;
                    else if ("number" != typeof this.end)
                        throw TypeError("结束处必须是数字");
                    if (this.start > this.end)
                        throw new Error("开始处必须 <= 结束处");
                    this.pos = this.start
                }
                if (null !== this.fd)
            ...
            WriteStream: function t(n, i) {
                ...
                if (void 0 !== this.start) {
                    if ("number" != typeof this.start)
                        throw TypeError("开始处必须是一个数字");
                    if (this.start < 0)
                        throw new Error("开始处必须>=0");
                    this.pos = this.start
                }
                this.busy = !1,
                this._queue = [],
                null === this.fd && (this._open = e.open,
...
, function(e, t, n) {
            ...
            return function(e, t, n, o) {
                ...
                if (s.isDirectory())
                    return function(e, t, n, i, o) {
                        ...
                        if (t && !t.isDirectory())
                            throw new Error(`无法用目录 '${i}' 覆盖非目录 '${n}'。`);
                        return f(n, i, o)
                    }(s, e, t, n, o);
                if (s.isFile() || s.isCharacterDevice() || s.isBlockDevice())
                    return function(e, t, n, i, o) {
                        return t ? function(e, t, n, i) {
                            if (i.overwrite)
                                return r.unlinkSync(n),
                                u(e, t, n, i);
                            if (i.errorOnExist)
                                throw new Error(`'${n}' 已经存在`)
                        }(e, n, i, o) : u(e, n, i, o)
                    }(s, e, t, n, o);
                if (s.isSymbolicLink())
                    return function(e, t, n, o) {
                        ...
                        if (e) {
                            ...
                            a.isSrcSubdir(s, e))
                                throw new Error(`无法复制 '${s}' 到其自身的子目录，'${e}'。`);
                            if (r.statSync(n).isDirectory() && a.isSrcSubdir(e, s))
                                throw new Error(`不能用 '${s}' 覆盖 '${e}'。`);
                            return function(e, t) {
    ...
    function u(e, t, n, i) {
        return r.copyFileSync(t, n),
        i.preserveTimestamps && function(e, t, n) {
            (function(e) {
                return 0 == (128 & e)
            }
            )(e) && function(e, t) {
    ...
    function f(e, t, n) {
        r.readdirSync(e).forEach(r=>function(e, t, n, r) {
            const o = i.join(t, e)
              , s = i.join(n, e)
              , {destStat: u} = a.checkPathsSync(o, s, "copy");
            return c(u, o, s, r)
        }(r, e, t, n))
    }
    e.exports = function(e, t, n) {
        ...
        n.preserveTimestamps && "ia32" === process.arch && console.warn("fs-extra：不建议在 32 位节点中使用 preserveTimestamps 选项；\n\n    参见 https://github.com/jprichardson/node-fs-extra/issues/269");
...
, function(e, t, n) {
    ...
    }),
    {
      ...
      , c = e=>{
        const t = new Error(`不允许操作：mkdir '${e}'`);
        return t.code = "EPERM",
        t.errno = -4048,
        t.path = e,
        t.syscall = "mkdir",
            ...
            try {
                ...
                if ("ENOENT" === t.code) {
                    ...
                    if (t.message.includes("null bytes"))
                        throw t;
                    return await n(i.dirname(e)),
                    n(e)
                }
                try {
                    if (!(await r.stat(e)).isDirectory())
                        throw new Error("路径不是一个有效的目录")
                } catch {
                    throw t
                }
            }
...
, function(e, t, n) {
    ...
    function h(e, t, n, i, o) {
        (i.dereference ? r.stat : r.lstat)(t, (s,a)=>s ? o(s) : a.isDirectory() ? function(e, t, n, i, o, s) {
            ...
            if (t && !t.isDirectory())
                return s(new Error(`无法用目录 '${i}' 覆盖非目录 '${n}'。`));
            return y(n, i, o, s)
    ...
    function v(e, t, n, o, s) {
        r.readlink(t, (t,a)=>t ? s(t) : (o.dereference && (a = i.resolve(process.cwd(), a)),
        e ? void r.readlink(n, (t,u)=>t ? "EINVAL" === t.code || "UNKNOWN" === t.code ? r.symlink(a, n, s) : s(t) : (o.dereference && (u = i.resolve(process.cwd(), u)),
        c.isSrcSubdir(a, u) ? s(new Error(`无法将 '${a}' 复制到其自身的子目录 '${u}'。`)) : e.isDirectory() && c.isSrcSubdir(u, a) ? s(new Error(`不能用 '${a}' 覆盖 '${u}'。`)) : function(e, t, n) {
...
, function(e, t, n) {
    ...
    function a(e, t, n) {
        ...
        t = {}),
        o(e, "rimraf: 缺少路径"),
        o.strictEqual(typeof e, "string", "rimraf: 路径应该是一个字符串"),
        o.strictEqual(typeof n, "function", "rimraf: 需要回调函数"),
        o(t, "rimraf: 提供的选项参数无效"),
        o.strictEqual(typeof t, "object", "rimraf: 选项应该是对象"),
        s(t),
        c(e, t, (function i(o) {
            if (o) {
    ...
    function c(e, t, n) {
        ...
        o(t),
        o("function" == typeof n),
        t.lstat(e, (r,i)=>r && "ENOENT" === r.code ? n(null) : r && "EPERM" === r.code ? u(e, t, r, n) : i && i.isDirectory() ? f(e, t, r, n) : void t.unlink(e, r=>{
            if (r) {
                if ("ENOENT" === r.code)
                    return n(null);
                if ("EPERM" === r.code)
            ...
            !s || "ENOTEMPTY" !== s.code && "EEXIST" !== s.code && "EPERM" !== s.code ? s && "ENOTDIR" === s.code ? r(n) : r(s) : function(e, t, n) {
                ...
                t.readdir(e, (r,o)=>{
                    ...
                    o.forEach(r=>{
                        a(i.join(e, r), t, r=>{
                            if (!s)
                                return r ? n(s = r) : void (0 == --c && t.rmdir(e, n))
                        }
                        )
                    }
                    )
        ...
        try {
            ...
            if ("ENOTEMPTY" === r.code || "EEXIST" === r.code || "EPERM" === r.code)
                !function(e, t) {
                    o(e),
                    o(t),
                    t.readdirSync(e).forEach(n=>h(i.join(e, n), t));
                    {
                        const n = Date.now();
                        do {
                            try {
    ...
    e.exports = {
        createFile: r((function(e, t) {
            ...
            o.stat(e, (r,a)=>{
                ...
                o.stat(c, (e,r)=>{
                    if (e)
                        return "ENOENT" === e.code ? s.mkdirs(c, e=>{
                            if (e)
                                return t(e);
                            n()
                        }
    ...
    e.exports = {
        createLink: r((function(e, t, n) {
            ...
            a(t, (c,u)=>c ? n(c) : u ? n(null) : void o.lstat(e, o=>{
                if (o)
                    return o.message = o.message.replace("lstat", "ensureLink"),
                    n(o);
                const c = i.dirname(t);
        ...
        createLinkSync: function(e, t) {
            ...
            try {
                ...
                throw e.message = e.message.replace("lstat", "ensureLink"),
                e
            }
            const n = i.dirname(t);
            return o.existsSync(n) || s.mkdirsSync(n),
            o.linkSync(e, t)
        }
    }
}
, function(e, t, n) {
    ...
    e.exports = {
        createSymlink: r((function(e, t, n, r) {
            ...
            m(t, (s,c)=>s ? r(s) : c ? r(null) : void l(e, t, (s,c)=>{
                if (s)
                    return r(s);
                e = c.toDst,
                p(c.toCwd, n, (n,s)=>{
...
, function(e, t, n) {
    ...
    e.exports = {
        symlinkPaths: function(e, t, n) {
            if (r.isAbsolute(e))
                return i.lstat(e, t=>t ? (t.message = t.message.replace("lstat", "ensureSymlink"),
                n(t)) : n(null, {
                    toCwd: e,
                    toDst: e
                }));
            {
                ...
                return o(a, (t,o)=>t ? n(t) : o ? n(null, {
                    toCwd: a,
                    toDst: e
                }) : i.lstat(e, t=>t ? (t.message = t.message.replace("lstat", "ensureSymlink"),
                n(t)) : n(null, {
                    toCwd: e,
        ...
        symlinkPathsSync: function(e, t) {
            ...
            if (r.isAbsolute(e)) {
                if (n = i.existsSync(e),
                !n)
                    throw new Error("绝对路径 srcpath 不存在");
                return {
                    toCwd: e,
                    toDst: e
                }
            }
            {
                ...
                if (n = i.existsSync(e),
                !n)
                    throw new Error("相对路径 srcpath 不存在");
                return {
                    toCwd: e,
...
, function(e, t, n) {
    ...
    const r = n(6).fromPromise
      , i = n(100);
    i.outputJson = r(n(106)),
    i.outputJsonSync = n(107),
...
, function(e, t, n) {
    ...
    function f(e) {
        ...
        var l = e.WriteStream;
        function d(e, t) {
            return this instanceof d ? (u.apply(this, arguments),
            this) : d.apply(Object.create(d.prototype), arguments)
        }
        function m(e, t) {
            return this instanceof m ? (l.apply(this, arguments),
            this) : m.apply(Object.create(m.prototype), arguments)
        }
    ...
    e.exports.closeSync = r.closeSync = (u = r.closeSync,
    function(e) {
...
, function(e, t, n) {
    ...
    function d(e) {
        return e ? function(t) {
            var n = e.call(r, t);
            return n.uid < 0 && (n.uid += 4294967296),
    ...
    e.exports = function(e) {
        ...
        e.chmodSync = l(e.chmodSync),
        e.fchmodSync = l(e.fchmodSync),
        e.lchmodSync = l(e.lchmodSync),
        e.stat = p(e.stat),
        e.fstat = p(e.fstat),
        e.lstat = p(e.lstat),
        ...
        u.checkPaths(e, t, "move", (n,f)=>{
            ...
            u.checkParentPaths(e, h, t, "move", n=>{
                ...
                a(i.dirname(t), n=>n ? r(n) : function(e, t, n, r) {
                    if (n)
                        return s(t, i=>i ? r(i) : l(e, t, n, r));
                    c(t, (i,o)=>i ? r(i) : o ? r(new Error("dest 已经存在。")) : l(e, t, n, r))
                }(e, t, o, r))
            }
            )
        }
...
, function(e, t, n) {
    ...
    ;
    o.inherits(d, a),
    l.transports.DailyRotateFile = d,
    ...
    d.prototype._write = function(e, t) {
        var n = this._stream.write(e);
        if (t)
            return !1 === n ? this._stream.once("drain", (function() {
                t(null, !0)
            }
            )) : void t(null, !0)
    }
    ...
    d.prototype.open = function(e) {
        return this.opening ? e(!0) : !this._stream || this.maxsize && this._size >= this.maxsize || this._filenameHasExpired() ? (this._cleanOldFiles(),
        e(!0),
        this._createStream()) : void e()
    }
    ,
    ...
    d.prototype._createStream = function() {
        ...
        function t(n) {
            var o = i.join(e.dirname, n);
            function s(t) {
                e._stream && (e._archive = !!e.zippedArchive && e._stream.path,
                e._stream.end(),
                e._stream.destroySoon()),
                ...
                function() {
                    var t = e._archive;
                    if (e._archive = !1,
                    t && r.existsSync(String(t))) {
                        var n = h.createGzip()
                          , i = r.createReadStream(String(t))
                          , o = r.createWriteStream(t + ".gz");
                        i.pipe(n).pipe(o),
                        r.unlinkSync(String(t))
                    }
                }()
            }
            r.stat(o, (function(n, r) {
                return n ? "ENOENT" !== n.code ? e.emit("error", n) : s(0) : !r || e.maxsize && r.size >= e.maxsize ? t(e._getFile(!0)) : e._filenameHasExpired() ? (e._year = e._getTime("year"),
    ...
    d.prototype._getFilename = function() {
        ...
        return this.prepend ? (".yyyy-MM-dd" === this.datePattern && (this.datePattern = "yyyy-MM-dd.",
        e = this.getFormattedDate()),
        e + this._basename) : this._basename + e
    }
    ,
    ...
    d.prototype._cleanOldFiles = function() {
        ...
        e.maxDays && r.readdir(e.dirname, (function(t, r) {
            if (t)
                console.error("读取目录时出错 ", e.dirname, t);
            else {
...
, function(e, t, n) {
    t.SourceMapGenerator = n(42).SourceMapGenerator,
    t.SourceMapConsumer = n(117).SourceMapConsumer,
    t.SourceNode = n(120).SourceNode
}
, function(e, t) {
    ...
    t.encode = function(e) {
        if (0 <= e && e < n.length)
            return n[e];
        throw new TypeError("必须在 0 和 63 之间: " + e)
    }
    ,
    t.decode = function(e) {
...
, function(e, t, n) {
    ...
    function c(e) {
        ...
        null != t.sections ? new f(t) : new u(t)
    }
    function u(e) {
        var t = e;
    ...
    function f(e) {
        ...
        this._sections = i.map((function(e) {
            if (e.url)
                throw new Error("支持未实现部分中的 url 字段。");
            var t = r.getArg(e, "offset")
              , n = r.getArg(t, "line")
              , i = r.getArg(t, "column");
            if (n < s.line || n === s.line && i < s.column)
                throw new Error("部分偏移必须有序且不重叠。");
            return s = t,
            {
                generatedOffset: {
                    generatedLine: n + 1,
    ...
    u.fromSourceMap = function(e) {
        ...
        for (var s = e._mappings.toArray().slice(), c = t.__generatedMappings = [], f = t.__originalMappings = [], h = 0, p = s.length; h < p; h++) {
            ...
            d.source && (m.source = i.indexOf(d.source),
    ...
    u.prototype._parseMappings = function(e, t) {
        for (var n, i, o, c, u, f = 1, h = 0, p = 0, d = 0, m = 0, y = 0, g = e.length, v = 0, w = {}, b = {}, _ = [], S = []; v < g; )
            if (";" === e.charAt(v))
                ...
                for ((n = new l).generatedLine = f,
                c = v; c < g && !this._charIsMappingSeparator(e, c); c++)
                    ;
                if (o = w[i = e.slice(v, c)])
                    v += i.length;
                else {
                    for (o = []; v < c; )
                        s.decode(e, v, b),
                        ...
                        o.push(u);
                    if (2 === o.length)
                        throw new Error("找到了一个源文件，但没有行和列(空的)");
                    if (3 === o.length)
                        throw new Error("找到了源文件，但没有列(有行)");
                    w[i] = o
                }
                n.generatedColumn = h + o[0],
                h = n.generatedColumn,
                o.length > 1 && (n.source = m + o[1],
                m += o[1],
    ...
    u.prototype._findMapping = function(e, t, n, r, o, s) {
        if (e[n] <= 0)
            throw new TypeError("行数必须大于或等于 1，得到 " + e[n]);
        if (e[r] < 0)
            throw new TypeError("列必须大于或等于 0，得到 " + e[r]);
    ...
    u.prototype.sourceContentFor = function(e, t) {
        ...
        if (t)
            return null;
        throw new Error('"' + e + '" 不在 SourceMap 中。')
    }
    ,
    ...
    f.prototype._parseMappings = function(e, t) {
        ...
        for (var n = 0; n < this._sections.length; n++)
            for (var i = this._sections[n], o = i.consumer._generatedMappings, s = 0; s < o.length; s++) {
                ...
                null !== i.consumer.sourceRoot && (u = r.join(i.consumer.sourceRoot, u)),
                this._sources.add(u),
...
, function(e, t) {
    ...
    function r(e, t, i, o) {
        if (i < o) {
            ...
            n(e, (l = i,
            f = o,
            Math.round(l + Math.random() * (f - l))), o);
...
, function(e, t, n) {
        ...
        return t.eachMapping((function(e) {
            if (null !== h) {
                if (!(l < e.generatedLine)) {
                    ...
                    return s[c] = n.substr(e.generatedColumn - f),
                    f = e.generatedColumn,
                    p(h, t),
                    void (h = e)
                }
    ...
    a.prototype.add = function(e) {
        if (Array.isArray(e))
            ...
            if (!e[s] && "string" != typeof e)
                throw new TypeError("需要 SourceNode、字符串或 SourceNode 和字符串的数组。拿到 " + e);
    ...
    a.prototype.toStringWithSourceMap = function(e) {
        ...
        return this.walk((function(e, r) {
            t.code += e,
            null !== r.source && null !== r.line && null !== r.column ? (o === r.source && s === r.line && a === r.column && c === r.name || n.addMapping({
                source: r.source,
                original: {
                    line: r.line,
                    column: r.column
...
, function(e, t, n) {
    (function() {
        ...
        e.exports = function() {
            ...
            return e.exceptionHandlers = [],
            e.onEventHandlerException = function(e) {
                return 0 === this.exceptionHandlers.length && (this.dispatch = this.exceptionHandlingDispatch),
                this.exceptionHandlers.push(e),
                new t((n = this,
                function() {
                    if (n.exceptionHandlers.splice(n.exceptionHandlers.indexOf(e), 1),
            ...
            e.exceptionHandlingDispatch = function(e, t) {
                ...
                try {
                    ...
                    a = [],
                    i = 0,
                    o = (s = this.exceptionHandlers).length; i < o; i++)
                        r = s[i],
                        a.push(r(n));
                    return a
                }
            ...
            ,
            e.prototype.dispose = function() {
                return this.handlersByEventName = null,
                this.disposed = !0
            }
            ,
            e.prototype.on = function(e, n, r) {
                ...
                return (i = this.handlersByEventName[e]) ? this.handlersByEventName[e] = r ? [n].concat(i) : i.concat(n) : this.handlersByEventName[e] = [n],
            ...
            e.prototype.emitAsync = function(e, t) {
                ...
                return (r = null != (o = this.handlersByEventName) ? o[e] : void 0) ? (i = function() {
                    ...
                    i = r.length; e < i; e++)
                        n = r[e],
                        o.push(this.constructor.dispatch(n, t));
                    return o
                }
                .call(this),
            ...
            e.prototype.getTotalListenerCount = function() {
                ...
                for (t = 0,
                n = 0,
                r = (i = Object.keys(this.handlersByEventName)).length; n < r; n++)
                    e = i[n],
                    t += this.handlersByEventName[e].length;
                return t
            }
            ,
            e
...
, function(e, t, n) {
    (function() {
        ...
        r = function(e) {
            if (null == t && (t = n(33)),
            !t.isDisposable(e))
                throw new TypeError("CompositeDisposable.add 的参数必须有一个 .dispose() 方法")
        }
    }
    ).call(this)
}
, function(e, t, n) {
    ...
    function i(e, t) {
        var n, r = "\n";
        return "object" == typeof t && null !== t && (t.spaces && (n = t.spaces),
        t.EOL && (r = t.EOL)),
        ...
        readFile: function(e, t, n) {
            ...
            i.readFile(e, t, (function(r, i) {
                ...
                try {
                    ...
                    return s ? (t.message = e + ": " + t.message,
                    n(t)) : n(null, null)
                }
                n(null, a)
            }
...
, function(e, t, n) {
    ...
    function(e) {
        ...
        e.HKEY_CURRENT_USER_LOCAL_SETTINGS = "HKEY_CURRENT_USER_LOCAL_SETTINGS",
    ...
    ,
    t.setValue = l,
    t.setValueSafe = function(e, t, n, r, i) {
        try {
            return l(e, t, n, r, i)
        } catch (e) {
            return !1
...
, function(e, t, n) {
        ...
        return a || (a = new Promise((e,t)=>{
            ...
            Object(s.ensureDir)(n).then(()=>{
                try {
                    ...
                    r.join(o, "desktop.production.log")));
                    e(t)
                } catch (e) {
                    t(e)
                }
    ...
    function N(e) {
        const t = e.id;
        if (!t)
            throw new Error("menuItem must specify id: " + e.label);
        const n = e.enabled
          , r = e.visible
          , i = e.label
          , o = e.checked
    ...
    class D {
        constructor() {
            this.emitter = new C.Emitter,
            this._loadTime = null,
            this._rendererReadyTime = null,
            this.minWidth = 960,
            this.minHeight = 660,
            this.shouldMaximizeOnShow = !1;
            const e = P()({
        ...
        load() {
            ...
            T(this.window),
            this.window.loadURL(function(...e) {
                const t = r.resolve(...e);
                return L()(t)
        ...
        show() {
            this.window.show(),
            this.shouldMaximizeOnShow && (this.shouldMaximizeOnShow = !1,
            this.window.maximize())
        }
        sendMenuEvent(e) {
            this.show(),
            this.window.webContents.send("menu-event", {
                name: e
            })
        }
        sendURLAction(e) {
            this.show(),
            this.window.webContents.send("url-action", {
                action: e
            })
        }
    ...
    function $() {
        for (const t of Object(q.enumerateValues)(q.HKEY.HKEY_CURRENT_USER, "Environment"))
            if ("Path" === t.name && ((e = t).type === q.RegistryValueType.REG_SZ || e.type === q.RegistryValueType.REG_EXPAND_SZ))
                return t.data.split(";").filter(e=>e.length > 0);
        var e;
        throw new Error("找不到 PATH 环境变量")
    }
    async function W(e) {
        let t;
    ...
    async function Q() {
        ...
        try {
            ...
            log.error("将 bin 路径插入 PATH 环境变量失败", e)
        }
    }
    function Z() {
    ...
    async function oe(e, t, n) {
        ...
        r.set("architecture", !0 === O.app.runningUnderRosettaTranslation || !0 === Object(ie.isRunningUnderARM64Translation)() ? "x64-emulated" : "arm64" === process.arch ? "arm64" : "x64"),
        r.set("sha", "9196a1ae226614a42bdf29c6d7b5c9ab2c59f2df"),
        r.set("version", O.app.getVersion()),
        t)
    ...
    class se {
        constructor(e, t) {
            ...
            this.window = new O.BrowserWindow(n),
            this.error = t,
            this.errorType = e
        }
        load() {
    ...
    function() {
        ...
        const e = Error;
        v = e.prepareStackTrace,
        e.prepareStackTrace = w
    }();
    let fe = null;
    const he = F();
    let pe = !1
        ...
        function(e, t) {
            ...
            n.onFailedToLoad(async()=>{
                await O.dialog.showMessageBox({
                    ...
                    message: "GitHub Desktop 遇到不可恢复的错误，需要重新启动。\n\n已向团队报告此问题，但如果您反复遇到此问题，请将此问题报告给 GitHub Desktop 问题跟踪器。\n\n" + (t.stack || t.message)
                }),
                O.app.relaunch(),
                O.app.quit()
            }
    ...
    ve.add("x-github-desktop-auth"),
    ve.add("github-windows"),
            ...
            case "--squirrel-uninstall":
                return async function() {
                    ...
                    try {
                        ...
                        log.error("从 PATH 环境变量中删除 bin 路径失败", e)
                    }
                }();
    ...
    if (!we) {
        ...
        _e = !e,
        O.app.on("second-instance", (e,t,n)=>{
            fe && (fe.isMinimized() && fe.restore(),
            fe.isVisible() || fe.show(),
            fe.focus()),
            Se(t)
        }
        ),
        ...
        log.info("收到可能的协议参数：" + e.length);
        {
            const t = e.filter(e=>{
                try {
                    ...
                    return log.error("无法将参数解析为 URL：" + e),
                    !1
                }
            }
            );
            e.includes("--protocol-launcher") && 1 === t.length ? be(t[0]) : log.error("收到格式错误的启动参数：" + e)
        }
    }
    function Ee(e) {
    ...
    process.env.GITHUB_DESKTOP_DISABLE_HARDWARE_ACCELERATION && (log.info("GITHUB_DESKTOP_DISABLE_HARDWARE_ACCELERATION 环境变量设置，禁用硬件加速"),
    ...
    O.app.on("ready", ()=>{
        ...
        function(e) {
            ...
            e.onBeforeRequest((e,r)=>{
                const {protocol: i, origin: o} = new URL(e.url);
                n.has(i) || t.has(e.id) || t.set(e.id, o),
                r({})
            }
            ),
            e.onBeforeSendHeaders((e,n)=>{
                const i = t.get(e.id)
                ...
                for (const [t,n] of Object.entries(e.requestHeaders))
                    r.has(t.toLowerCase()) || (s[t] = n);
                return log.debug("清理跨域重定向到" + o),
                n({
                    requestHeaders: s
                })
            }
            ),
            e.onCompleted(e=>t.delete(e.id))
        }(O.session.defaultSession.webRequest),
        ...
        O.ipcMain.on("update-preferred-app-menu-item-labels", (e,t)=>{
            ...
            if (null === r)
                return O.Menu.setApplicationMenu(n),
                void (null !== fe && fe.sendAppMenu());
            let i = !1;
            for (const e of Object(I.getAllMenuItems)(n)) {
                ...
                n ? (n.label !== e.label && (i = !0),
                n.enabled !== e.enabled && (e.enabled = n.enabled,
                i = !0)) : i = !0
            }
            i && fe && (O.Menu.setApplicationMenu(n),
            fe.sendAppMenu())
        }
        ),
        ...
        O.ipcMain.on("update-menu-state", (e,t)=>{
            ...
            if (null !== r) {
                for (const e of t) {
                    ...
                    o ? void 0 !== i.enabled && o.enabled !== i.enabled && (o.enabled = i.enabled,
                    n = !0) : M("Unknown menu id: " + t)
                }
                n && fe && (O.Menu.setApplicationMenu(r),
                fe.sendAppMenu())
            } else
                log.debug("无法获取当前菜单，开始退出...")
        }
        ),
        ...
        O.ipcMain.on("open-external", async(e,{path: t})=>{
            ...
            try {
                await O.shell.openExternal(t),
                r = !0
            } catch (e) {
                log.error(`调用 openExternal 失败： '${e}'`),
                r = !1
            }
        ...
        O.ipcMain.on("show-item-in-folder", (e,{path: t})=>{
            l.stat(t, e=>{
                e ? log.error(`无法在以下位置找到文件 '${t}'`, e) : O.shell.showItemInFolder(t)
            }
            )
        }
        ),
        O.ipcMain.on("show-folder-contents", async(e,{path: t})=>{
            const n = await Object(s.stat)(t).catch(e=>(log.error("无法检索文件信息 " + t, e),
            null));
            if (n)
                return n.isDirectory() ? void Object(re.a)(t) : (log.error(`试图获取非文件夹的文件夹内容 '${t}'`),
                void O.shell.showItemInFolder(t))
        }
        ))
    }
    ),
